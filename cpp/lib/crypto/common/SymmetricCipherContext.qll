...
abstract class SymmetricCipherInitWithKey extends SymmetricCipherInit {
  ...
  override int getAStrongRandomnessSink() {
    result = this.getKey()
  }
}
...
abstract class SymmetricCipherInitWithKeyAndIv extends SymmetricCipherInitWithKey, SymmetricCipherInitWithIv {
  override int getAStrongRandomnessSink() {
    result = this.getKey() or result = this.getIv()
  }
}
