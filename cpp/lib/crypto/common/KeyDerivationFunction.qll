...
abstract class KeyDerivationFunctionWithPassword extends KeyDerivationFunction {
  ...
  override int getAStrongPasswordSink() {
...
abstract class KeyDerivationFunctionWithPasswordAndSalt extends
  KeyDerivationFunctionWithPassword,
...
class KeyDerivationFunctionWithPasswordCall extends FunctionCall {
  ...
  KeyDerivationFunctionWithPasswordCall() {
    this.getTarget() = kdf
  }

  Expr getAStrongPasswordSink() {
    result = this.getArgument(kdf.getAStrongPasswordSink())
  }
}
...
class KeyDerivationFunctionSink extends StrongPasswordSink {
  ...
  KeyDerivationFunctionSink() {
    this = kdf.getAStrongPasswordSink()
  }
