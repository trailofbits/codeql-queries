...
class EVP_EncryptInit extends SymmetricCipherInitWithKeyAndIv, ReturnsErrorCode {
  EVP_EncryptInit() { this.getQualifiedName() = "EVP_EncryptInit" }

  int getCipher() { result = 1 }

  override int getAContextArg() { result = 0 }

  override int getKey() { result = 2 }

  override int getIv() { result = 3 }
}
...
class EVP_EncryptInit_ex extends SymmetricCipherInitWithKeyAndIv, ReturnsErrorCode {
  EVP_EncryptInit_ex() { this.getQualifiedName() = "EVP_EncryptInit_ex" }

  int getCipher() { result = 1 }

  override int getAContextArg() { result = 0 }

  override int getKey() { result = 3 }

  override int getIv() { result = 4 }
}

// int EVP_DecryptInit_ex(EVP_CIPHER_CTX *ctx, const EVP_CIPHER *type,
//                        ENGINE *impl, const unsigned char *key, const unsigned char *iv);
class EVP_DecryptInit_ex extends SymmetricCipherInitWithKeyAndIv, ReturnsErrorCode {
  EVP_DecryptInit_ex() { this.getQualifiedName() = "EVP_DecryptInit_ex" }
...
class EVP_CipherInit extends SymmetricCipherInitWithKeyAndIv, ReturnsErrorCode {
  EVP_CipherInit() { this.getQualifiedName() = "EVP_CipherInit" }
...
class EVP_EncryptUpdate extends SymmetricCipherUpdate, ReturnsErrorCode {
  EVP_EncryptUpdate() { this.getQualifiedName() = "EVP_EncryptUpdate" }
...
class EVP_DecryptUpdate extends SymmetricCipherUpdate, ReturnsErrorCode {
  EVP_DecryptUpdate() { this.getQualifiedName() = "EVP_DecryptUpdate" }
...
class EVP_CipherUpdate extends SymmetricCipherUpdate, ReturnsErrorCode {
  EVP_CipherUpdate() { this.getQualifiedName() = "EVP_CipherUpdate" }
...
class EVP_EncryptFinal extends SymmetricCipherFinal, ReturnsErrorCode {
  EVP_EncryptFinal() { this.getQualifiedName() = "EVP_EncryptFinal" }
...
class EVP_EncryptFinal_ex extends SymmetricCipherFinal, ReturnsErrorCode {
  EVP_EncryptFinal_ex() { this.getQualifiedName() = "EVP_EncryptFinal_ex" }
...
class EVP_DecryptFinal_ex extends SymmetricCipherFinal, ReturnsErrorCode {
  EVP_DecryptFinal_ex() { this.getQualifiedName() = "EVP_DecryptFinal_ex" }
...
class EVP_CipherFinal extends SymmetricCipherFinal, ReturnsErrorCode {
  EVP_CipherFinal() { this.getQualifiedName() = "EVP_CipherFinal" }
...
class EVP_EncryptTuple extends InitUpdateFinalTuple {
  EVP_EncryptTuple() { this = "EVP_EncryptTuple" }
  ...
  override UpdateFunction getUpdate() { result instanceof EVP_EncryptUpdate }
...
class EVP_DecryptTuple extends InitUpdateFinalTuple {
  EVP_DecryptTuple() { this = "EVP_DecryptTuple" }
  ...
  override UpdateFunction getUpdate() { result instanceof EVP_DecryptUpdate }
...
class EVP_CipherTuple extends InitUpdateFinalTuple {
  ...
  override UpdateFunction getUpdate() { result instanceof EVP_CipherUpdate }
...
class EVP_BytesToKey extends KeyDerivationFunctionWithPasswordAndSalt, ReturnsErrorCode {
  EVP_BytesToKey() { this.getQualifiedName() = "EVP_BytesToKey" }

  override int getPassword() { result = 3 }

  override int getSalt() { result = 2 }
}
...
class PKCS5_PBE_keyivgen extends KeyDerivationFunctionWithPassword, ReturnsErrorCode {
  PKCS5_PBE_keyivgen() { this.getQualifiedName() = "PKCS5_PBE_keyivgen" }

  override int getPassword() { result = 1 }

  int getMode() { result = 6 }
}
...
class PKCS5_PBKDF2_HMAC_SHA1 extends KeyDerivationFunctionWithPasswordAndSalt, ReturnsErrorCode {
  PKCS5_PBKDF2_HMAC_SHA1() { this.getQualifiedName() = "PKCS5_PBKDF2_HMAC_SHA1" }

  override int getPassword() { result = 0 }
...
class PKCS5_PBKDF2_HMAC extends KeyDerivationFunctionWithPasswordAndSalt, ReturnsErrorCode {
  PKCS5_PBKDF2_HMAC() { this.getQualifiedName() = "PKCS5_PBKDF2_HMAC" }
...
class EVP_PBE_scrypt extends KeyDerivationFunctionWithPasswordAndSalt, ReturnsErrorCode {
  EVP_PBE_scrypt() { this.getQualifiedName() = "EVP_PBE_scrypt" }
...
class EVP_PBE_scrypt_ex extends KeyDerivationFunctionWithPasswordAndSalt, ReturnsErrorCode {
  EVP_PBE_scrypt_ex() { this.getQualifiedName() = "EVP_PBE_scrypt" }
...
class PKCS5_v2_scrypt_keyivgen extends KeyDerivationFunctionWithPassword, ReturnsErrorCode {
  PKCS5_v2_scrypt_keyivgen() { this.getQualifiedName() = "PKCS5_v2_scrypt_keyivgen" }
...
class PKCS5_v2_scrypt_keyivgen_ex extends KeyDerivationFunctionWithPassword, ReturnsErrorCode {
  PKCS5_v2_scrypt_keyivgen_ex() { this.getQualifiedName() = "PKCS5_v2_scrypt_keyivgen" }
...
class EVP_PBE_CipherInit extends KeyDerivationFunctionWithPassword, ReturnsErrorCode {
  EVP_PBE_CipherInit() { this.getQualifiedName() = "EVP_PBE_CipherInit" }
...
class EVP_PBE_CipherInit_ex extends KeyDerivationFunctionWithPassword, ReturnsErrorCode {
  EVP_PBE_CipherInit_ex() { this.getQualifiedName() = "EVP_PBE_CipherInit" }
...
class EVP_CIPHER extends FunctionCall {
  ...
  EVP_CIPHER() {
    // AES variants.
    this.getTarget().getName().matches("%EVP_aes_256_cbc%") and keySize = 32
    or
    this.getTarget().getName().matches("%EVP_aes_256_cfb%") and keySize = 32
    or
    this.getTarget().getName().matches("%EVP_aes_256_ctr%") and keySize = 32
    or
    this.getTarget().getName().matches("%EVP_aes_256_ecb%") and keySize = 32
    or
    this.getTarget().getName().matches("%EVP_aes_256_ofb%") and keySize = 32
    or
    this.getTarget().getName().matches("%EVP_aes_256_xts%") and keySize = 64
    or
    this.getTarget().getName().matches("%EVP_aes_192%") and keySize = 24
    or
    this.getTarget().getName().matches("%EVP_aes_128_cbc%") and keySize = 16
    or
    this.getTarget().getName().matches("%EVP_aes_128_cfb%") and keySize = 16
    or
    this.getTarget().getName().matches("%EVP_aes_128_ctr%") and keySize = 16
    or
    this.getTarget().getName().matches("%EVP_aes_128_ecb%") and keySize = 16
    or
    this.getTarget().getName().matches("%EVP_aes_128_ofb%") and keySize = 16
    or
    this.getTarget().getName().matches("%EVP_aes_128_xts%") and keySize = 32
    or
    // Chacha20 variants.
